...
!(function (t, e) {
    ...
    return (a = Object.assign
      ...
      : function (t) {
          for (var e = 1; e < arguments.length; e++) {
            var n,
              o = arguments[e];
            for (n in o) !{}.hasOwnProperty.call(o, n) || (t[n] = o[n]);
          }
          return t;
  ...
  function f(t, e, n) {
    t.addEventListener(e, n, !y && h);
  }
  function p(t, e, n) {
    t.removeEventListener(e, n, !y && h);
  }
  function g(t, e) {
  ...
  function m(t) {
    return t.host && t !== document && t.host.nodeType && t.host !== t
      ? t.host
      : t.parentNode;
  }
  function P(t, e, n, o) {
    if (t) {
      ...
      do {
        if (
          (null != e && (">" !== e[0] || t.parentNode === n) && g(t, e)) ||
          (o && t === n)
        )
          return t;
      } while (t !== n && (t = m(t)));
  ...
  function F(t, e) {
    for (
      ...
      n && (n === Ht.ghost || "none" === R(n, "display") || (e && !g(n, e)));
  ...
  var W = [],
    ...
    G = {
      ...
      initializePlugins: function (n, o, i, t) {
        for (var e in (W.forEach(function (t) {
          var e = t.pluginName;
  ...
  function U(t) {
    ...
    if ((e = e || (n && n[K]))) {
      ...
      var v,
        b = I(I({}, p), G.getEventProperties(o, e));
      for (v in b) g[v] = b[v];
  ...
  var $,
    ...
    Nt = d,
    It = w || y ? "cssFloat" : "float",
    Pt = At && !n && !d && "draggable" in document.createElement("div"),
    kt = (function () {
      if (At) {
        if (y) return !1;
  ...
  function jt(t) {
    $ && $.parentNode[K]._isOutsideThisEl(t.target);
  }
  function Ht(t, e) {
    ...
    var n,
      ...
      i = {
        ...
        supportPointer:
          !1 !== Ht.supportPointer && "PointerEvent" in window && (!u || d),
        emptyInsertThreshold: 5,
      };
    for (n in (G.initializePlugins(this, t, i), i)) n in e || (e[n] = i[n]);
    for (o in (Xt(e), this))
      "_" === o.charAt(0) &&
  ...
  (Ht.prototype = {
    ...
    _getDirection: function (t, e) {
      return "function" == typeof this.options.direction
        ? this.options.direction.call(this, t, e, $)
      ...
      if (e.cancelable) {
        ...
        if (
          ...
          !$ &&
            ...
            !(((l = P(l, t.draggable, o, !1)) && l.animated) || nt === l))
        ) {
          if (((rt = j(l)), (lt = j(l, t.draggable)), "function" == typeof c)) {
    ...
    _prepareDragStart: function (t, e, n) {
      ...
      n &&
        ...
        f(l, "touchmove", Ft),
        a.supportPointer
          ? (f(l, "pointerup", i._onDrop),
            this.nativeDraggable || f(l, "pointercancel", i._onDrop))
          : (f(l, "mouseup", i._onDrop),
            f(l, "touchend", i._onDrop),
            f(l, "touchcancel", i._onDrop)),
        c &&
          this.nativeDraggable &&
        ...
        (this.nativeDraggable && (w || y))
          ...
          ? this._onDrop()
          : (a.supportPointer
              ? (f(l, "pointerup", i._disableDelayedDrag),
                f(l, "pointercancel", i._disableDelayedDrag))
              : (f(l, "mouseup", i._disableDelayedDrag),
                f(l, "touchend", i._disableDelayedDrag),
                f(l, "touchcancel", i._disableDelayedDrag)),
            f(l, "mousemove", i._delayedDragTouchMoveHandler),
            f(l, "touchmove", i._delayedDragTouchMoveHandler),
            a.supportPointer &&
              f(l, "pointermove", i._delayedDragTouchMoveHandler),
      ...
      (e = e || ("touch" == t.pointerType && t)),
        !this.nativeDraggable || e
          ? this.options.supportPointer
            ...
            : f(document, e ? "touchmove" : "mousemove", this._onTouchMove)
          : (f($, "dragend", this), f(tt, "dragstart", this._onDragStart));
      try {
        document.selection
          ? zt(function () {
      ...
      (Et = !1),
        tt && $
          ? (q("dragStarted", this, { evt: e }),
            this.nativeDraggable && f(document, "dragover", jt),
            (n = this.options),
            t || k($, n.dragClass, !1),
            k($, n.ghostClass, !0),
            (Ht.active = this),
    ...
    _emulateDragOver: function () {
      if (ht) {
        ...
        for (
          var t = document.elementFromPoint(ht.clientX, ht.clientY), e = t;
          t &&
          t.shadowRoot &&
          (t = t.shadowRoot.elementFromPoint(ht.clientX, ht.clientY)) !== e;

        )
          e = t;
        if (($.parentNode[K]._isOutsideThisEl(t), e))
          do {
            if (e[K])
              if (
                e[K]._onDragOver({
    ...
    _onTouchMove: function (t) {
      if (dt) {
        var e = this.options,
          ...
          e = Nt && Dt && S(Dt),
          a =
            (i.clientX - dt.clientX + o.x) / (a || 1) +
            (e ? e[0] - xt[0] : 0) / (a || 1),
          l =
            (i.clientY - dt.clientY + o.y) / (l || 1) +
            (e ? e[1] - xt[1] : 0) / (l || 1);
        if (!Ht.active && !Et) {
          if (
            n &&
    ...
    _appendGhost: function () {
      if (!J) {
        ...
        if (Nt) {
          for (
            Dt = t;
            "static" === R(Dt, "position") &&
            "none" === R(Dt, "transform") &&
            Dt !== document;

          )
            Dt = Dt.parentNode;
          Dt !== document.body && Dt !== document.documentElement
            ? (Dt === document && (Dt = O()),
              (e.top += Dt.scrollTop),
              (e.left += Dt.scrollLeft))
            : (Dt = O()),
            (xt = S(Dt));
        }
        k((J = $.cloneNode(!0)), n.ghostClass, !1),
          k(J, n.fallbackClass, !0),
          k(J, n.dragClass, !0),
          R(J, "transition", ""),
          R(J, "transform", ""),
          R(J, "box-sizing", "border-box"),
          R(J, "margin", 0),
          R(J, "top", e.top),
          R(J, "left", e.left),
          R(J, "width", e.width),
          R(J, "height", e.height),
          R(J, "opacity", "0.8"),
          R(J, "position", Nt ? "absolute" : "fixed"),
          R(J, "zIndex", "100000"),
          R(J, "pointerEvents", "none"),
          (Ht.ghost = J),
          t.appendChild(J),
          R(
            J,
            "transform-origin",
            (gt / parseInt(J.style.width)) * 100 +
              "% " +
    ...
    _onDragStart: function (t, e) {
      ...
      q("dragStart", this, { evt: t }),
        Ht.eventCanceled
          ...
          : (q("setupClone", this),
            Ht.eventCanceled ||
              ((ot = T($)).removeAttribute("id"),
              (ot.draggable = !1),
              (ot.style["will-change"] = ""),
              this._hideClone(),
              k(ot, this.options.chosenClass, !1),
              (Ht.clone = ot)),
            (n.cloneId = zt(function () {
              q("clone", n),
                Ht.eventCanceled ||
                  (n.options.removeCloneOnHide || tt.insertBefore(ot, $),
                  n._hideClone(),
                  Z({ sortable: n, name: "clone" }));
            })),
            e || k($, i.dragClass, !0),
            e
              ? ((St = !0), (n._loopId = setInterval(n._emulateDragOver, 50)))
        ...
        if (
          ...
          u &&
            ...
            (d
              ? h || (i = Q !== tt)
              : ut === this ||
                ((this.lastPutMode = ct.checkPull(this, u, $, n)) &&
                  c.checkPut(this, u, $, n))))
        ) {
          if (
          ...
          if (i)
            return (
              ...
              O("revert"),
              Ht.eventCanceled ||
                (et ? tt.insertBefore($, et) : tt.appendChild($)),
              A(!0)
            );
          ...
          if (
            ...
            if (
              ...
              var v = B(a, 0, s, !0);
              if (v === $) return A(!1);
              if (((D = X((l = v))), !1 !== Lt(tt, a, $, o, l, D, n, !1)))
                return M(), a.insertBefore($, v), (Q = a), N(), A(!0);
              ...
              var b,
                ...
                S =
                  ...
                  !(_ === v || t === S || _ + C / 2 === v + x / 2)),
                _ = r ? "top" : "left",
                C = Y(l, "top", "top") || Y($, "top", "top"),
                v = C ? C.scrollTop : void 0;
              if (
                (bt !== l &&
                  ((y = D[_]), (Ct = !1), (Tt = (!S && s.invertSwap) || E)),
                0 !==
                    ...
                    if (!a)
                      if (l && wt < c * i) {
                        if (
                          ...
                          n = !0;
                        else if (1 === yt ? s < t + wt : o - wt < s) return -yt;
                      } else if (
                        t + (c * (1 - i)) / 2 < s &&
                        s < o - (c * (1 - i)) / 2
                      )
                ...
                for (
                  var T = j($);
                  (w = Q.children[(T -= b)]) &&
                  ("none" === R(w, "display") || w === J);

                );
              if (0 === b || w === l) return A(!1);
              yt = b;
              var x = (bt = l).nextElementSibling,
                E = !1,
                S = Lt(tt, a, $, o, l, D, n, (E = 1 === b));
              if (!1 !== S)
                return (
                  (1 !== S && -1 !== S) || (E = 1 === S),
                  (Ot = !0),
                  ...
                  E && !x
                    ? a.appendChild($)
                    : l.parentNode.insertBefore($, E ? x : l),
                  C && H(C, 0, v - C.scrollTop),
                  (Q = $.parentNode),
                  void 0 === y || Tt || (wt = Math.abs(y - X(l)[_])),
                  N(),
                  A(!0)
                );
            }
      ...
      function A(t) {
        return (
          ...
          t &&
            ...
            p !== f &&
              (k($, (ut || u).options.ghostClass, !1), k($, s.ghostClass, !0)),
            ut !== p && p !== Ht.active
              ? (ut = p)
              : p === Ht.active && ut && (ut = null),
          ...
          s.dragoverBubble ||
            n.rootEl ||
            l === document ||
            ($.parentNode[K]._isOutsideThisEl(n.target), t || Ft(n)),
    ...
    _offMoveEvents: function () {
      p(document, "mousemove", this._onTouchMove),
        ...
        p(document, "dragover", Ft),
        p(document, "mousemove", Ft),
        p(document, "touchmove", Ft);
    },
      ...
      (at = j($)),
        ...
        Ht.eventCanceled ||
          ...
          t &&
            ...
            (tt === Q || (ut && "clone" !== ut.lastPutMode)) &&
              ot &&
              ot.parentNode &&
              ot.parentNode.removeChild(ot),
            $ &&
              (this.nativeDraggable && p($, "dragend", this),
              Kt($),
              ($.style["will-change"] = ""),
              vt && !Et && k($, (ut || this).options.ghostClass, !1),
              k($, this.options.chosenClass, !1),
              Z({
                sortable: this,
                name: "unchoose",
                toEl: Q,
              ...
              Ht.active &&
                ((null != at && -1 !== at) || ((at = rt), (st = lt)),
                Z({ sortable: this, name: "end", toEl: Q, originalEvent: t }),
                this.save())))),
        this._nulling();
    },
    _nulling: function () {
    ...
    _showClone: function (t) {
      "clone" === t.lastPutMode
        ? it &&
          (q("showClone", this),
          Ht.eventCanceled ||
            ($.parentNode != tt || this.options.group.revertClone
              ? et
                ? tt.insertBefore(ot, et)
                : tt.appendChild(ot)
              : tt.insertBefore(ot, $),
    ...
    (Ht.mount = function () {
      ...
      (e = e[0].constructor === Array ? e[0] : e).forEach(function (t) {
        ...
        t.utils && (Ht.utils = I(I({}, Ht.utils), t.utils)), G.mount(t);
      });
    }),
          ...
          var f = h,
            ...
            p =
              ...
              (Math.abs(m - a) <= l && p + w < _) -
                (Math.abs(g - a) <= l && !!p);
          if (!Jt[d]) for (var x = 0; x <= d; x++) Jt[x] || (Jt[x] = {});
          (Jt[d].vx == T && Jt[d].vy == p && Jt[d].el === f) ||
            ((Jt[d].el = f),
            (Jt[d].vx = T),
            (Jt[d].vy = p),
            ...
            (0 == T && 0 == p) ||
              ...
              (Jt[d].pid = setInterval(
                function () {
                  o && 0 === this.layer && Ht.active._onTouchMove($t);
                  var t = Jt[this.layer].vy ? Jt[this.layer].vy * s : 0,
                    e = Jt[this.layer].vx ? Jt[this.layer].vx * s : 0;
                  ("function" == typeof i &&
                    "continue" !==
                      i.call(
                        Ht.dragged.parentNode[K],
                        e,
                        t,
                        n,
                        $t,
                  ...
                  ? (ie(e, this.options, t, n),
                    ...
                    !te ||
                      ...
                      (Qt = setInterval(function () {
                        ...
                        t !== o && ((o = t), ee()), ie(e, i.options, t, n);
                      }, 10)),
                      (Vt = r),
                      (Zt = a)))
                  : this.options.bubbleScroll && M(t, !0) !== O()
                  ? ie(e, this.options, M(t, !1), !1)
                  : ee();
            },
          }),
            ...
            dragOverValid: function (t) {
              ...
              i.options.swap &&
                ...
                n &&
                  n !== t &&
                  ((t = oe),
                  (oe = !1 !== o(n) ? (k(n, i.swapClass, !0), n) : null),
                  t && t !== oe && k(t, i.swapClass, !1)),
                r(),
                e(!0),
                a());
            },
        ...
        return (
          (t.prototype = {
            ...
            setupClone: function (t) {
              ...
              if (this.isMultiDrag) {
                for (var n = 0; n < he.length; n++)
                  fe.push(T(he[n])),
                    (fe[n].sortableIndex = he[n].sortableIndex),
                    (fe[n].draggable = !1),
                    (fe[n].style["will-change"] = ""),
                    k(fe[n], this.options.selectedClass, !1),
                    he[n] === ce && k(fe[n], this.options.chosenClass, !1);
                e._hideClone(), t();
              }
            },
            clone: function (t) {
              ...
              this.isMultiDrag &&
                (this.options.removeCloneOnHide ||
                  (he.length && se === e && (ve(!0, n), o("clone"), t())));
            },
            ...
            dragStartGlobal: function (t) {
              t.sortable;
              !this.isMultiDrag && se && se.multiDrag._deselectMultiDrag(),
                he.forEach(function (t) {
                  t.sortableIndex = j(t);
                }),
            ...
            revert: function (t) {
              ...
              1 < he.length &&
                (he.forEach(function (t) {
                  r.addAnimationState({ target: t, rect: ge ? X(t) : a }),
                    A(t),
                    (t.fromRect = a),
            ...
            dragOverCompleted: function (t) {
              ...
              i &&
                ...
                t.animation &&
                  1 < he.length &&
                  (ge || (!o && !r.options.sort && !l)) &&
                  ((e = X(ce, !1, !0, !0)),
                  he.forEach(function (t) {
                    t !== ce && (x(t, e), a.appendChild(t));
                  }),
                  (ge = !0)),
                o ||
                  (ge || be(),
            ...
            drop: function (t) {
              ...
              s &&
                ...
                me ||
                  ...
                  k(ce, o.selectedClass, !~he.indexOf(ce)),
                  ~he.indexOf(ce)
                    ...
                    : (he.push(ce),
                      ...
                      s.shiftKey && le && d.el.contains(le)
                        ? ((r = j(le)),
                          (a = j(ce)),
                          ~r &&
                            ~a &&
                ...
                me &&
                  ...
                  (u[K].options.sort || u !== c) &&
                    1 < he.length &&
                    ((n = X(ce)),
                    (e = j(ce, ":not(." + this.options.selectedClass + ")")),
                    !pe && o.animation && (ce.thisAnimationDuration = null),
                    p.captureAnimationState(),
                    pe ||
                      (o.animation &&
                        ((ce.fromRect = n),
                        he.forEach(function (t) {
                          ...
                          (t.thisAnimationDuration = null),
                            t !== ce &&
                              ((e = ge ? X(t) : n),
                              (t.fromRect = e),
                              p.addAnimationState({ target: t, rect: e }));
                        })),
                      be(),
                      he.forEach(function (t) {
            ...
            nullingGlobal: function () {
              (this.isMultiDrag = me = !1), (fe.length = 0);
            },
            ...
            utils: {
              ...
              deselect: function (t) {
                ...
                e &&
                  e.options.multiDrag &&
                  ~n &&
                  (k(t, e.options.selectedClass, !1), he.splice(n, 1));
              },
            },
            eventProperties: function () {
              var n = this,
